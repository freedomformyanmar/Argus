        ...
        ContactAdapter(
            onDeleteClick = {
                ...
                val inputEditText = EditText(this).apply {
                    ...
                    layoutParams = lp
                    setText(contactTable.name)
                }



                MaterialAlertDialogBuilder(this)
                    .setTitle("နာမည်ပြင်ရန်")
                    ...
                    .setOnDismissListener {
                        ...
                        if (newName.isNotEmpty()) {
                            database.contactTableQueries.updateName(
                                newName,
        ...
        lifecycleScope.launch {
            if (uri != null) {
                ...
                try {
                    ...
                    database.contactTableQueries.insertOrReplace(
                        user.number,
                        user.secretCode,
                        "User"
                    )
